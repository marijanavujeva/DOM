...
document.getElementById("prvi").style.fontSize = "1,5rem";
document.getElementById("drugi").style.fontSize = "1,5rem";
document.getElementById("treca").style.fontSize = "1,5rem";
document.getElementById("prva").style.fontSize = "1,5rem";
document.getElementById("konj").style.fontSize = "1,5rem";
